...
/**
 * システム名：社員管理システム クラス名 ：EmployeeDAO 処理概要 ：ログイン画面のDAO プロジェクト名：HrsmUcs(ログイン画面) 作成者
 * ：高原 優 作成日付：2019/07/10(水)
 */
...
public class EmployeeDAO extends BaseDAO {
	...
	/**
	 * メソッド名:findByEmployee 説明: 登録されている社員情報を検索する。
	 * 
	 * @param: employeeBean
