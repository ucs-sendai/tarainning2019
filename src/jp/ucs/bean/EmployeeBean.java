...
public class EmployeeBean {
	...
	public EmployeeBean(String empName, String ruby, DeptBean dept, String pass, String entryDate) {
		this.empName = empName;
		this.ruby = ruby;
		this.dept = dept;
		this.pass = pass;
	 ...
	 * @param dept:部門IDと部門名
	 */
	public EmployeeBean(String propertyId, String serialId, String empName, String ruby, String pass, String entryDate,
			DeptBean dept) {
		this.propertyId = propertyId;
		this.serialId = serialId;
		this.empName = empName;
	...
	/**
	 * メソッド名:getPropertyId 説明:社員IDを返す
	 * 
	 * @return propertyId
	 */
