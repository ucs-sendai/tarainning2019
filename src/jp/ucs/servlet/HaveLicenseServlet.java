...
import jp.ucs.logic.HaveLicenseRegisterLogic;
...
@WebServlet("/HaveLicense")
public class HaveLicenseServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;


	public HaveLicenseServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher(Constants.haveLicenseRegister);
